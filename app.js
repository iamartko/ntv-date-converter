(function () {
  ...
  var TRANSLATIONS = {
    ua: {
      ...
      footerYear: '© 2026',
      footerDisclaimer: 'Сайт створено для розваги фанатом для фанатів і є некомерційним.',
      yearPlaceholder: 'Рік',
      dayPlaceholder: 'День',
    ...
    en: {
      ...
      footerYear: '© 2026',
      footerDisclaimer: 'This website was created for fun by a fan, for fans, and is non-profit.',
